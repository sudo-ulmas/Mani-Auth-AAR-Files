...
public class Api {
  ...
  public enum ManiEnvironment {
    ...
    ManiEnvironment(final int index) {
      this.index = index;
    }
  }
  ...
  public enum ManiResidentType {
    ...
    ManiResidentType(final int index) {
      this.index = index;
    }
  }
  ...
  public enum DesignVariant {
    ...
    DesignVariant(final int index) {
      this.index = index;
    }
  }

  public enum PullyBrightness {
    LIGHT(0),
    DARK(1);

    final int index;

    PullyBrightness(final int index) {
      this.index = index;
    }
  }
  ...
  public static final class Token {
    ...
    static @NonNull Token fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      Token pigeonResult = new Token();
      Object accessToken = pigeonVar_list.get(0);
      pigeonResult.setAccessToken((String) accessToken);
      Object refreshToken = pigeonVar_list.get(1);
  ...
  public static final class HostInfo {
    ...
    public @Nullable String getLastLogin() {
      return lastLogin;
    }

    public void setLastLogin(@Nullable String setterArg) {
    ...
    private @Nullable PullyBrightness brightness;

    public @Nullable PullyBrightness getBrightness() {
      return brightness;
    }

    public void setBrightness(@Nullable PullyBrightness setterArg) {
    ...
    public boolean equals(Object o) {
      ...
      return Objects.equals(paymentSystemId, that.paymentSystemId) && Objects.equals(locale, that.locale) && Objects.equals(pinfl, that.pinfl) && phoneNumber.equals(that.phoneNumber) && Objects.equals(lastLogin, that.lastLogin) && Objects.equals(environment, that.environment) && Objects.equals(residentType, that.residentType) && Objects.equals(designVariant, that.designVariant) && Objects.equals(brightness, that.brightness);
    }

    @Override
    public int hashCode() {
      return Objects.hash(paymentSystemId, locale, pinfl, phoneNumber, lastLogin, environment, residentType, designVariant, brightness);
    }
    ...
    public static final class Builder {
      ...
      @CanIgnoreReturnValue
      public @NonNull Builder setLastLogin(@Nullable String setterArg) {
        this.lastLogin = setterArg;
        return this;
      }
      ...
      @CanIgnoreReturnValue
      public @NonNull Builder setBrightness(@Nullable PullyBrightness setterArg) {
        this.brightness = setterArg;
        return this;
      }
    ...
    static @NonNull HostInfo fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      HostInfo pigeonResult = new HostInfo();
      Object paymentSystemId = pigeonVar_list.get(0);
      pigeonResult.setPaymentSystemId((String) paymentSystemId);
      Object locale = pigeonVar_list.get(1);
      pigeonResult.setLocale((String) locale);
      Object pinfl = pigeonVar_list.get(2);
      pigeonResult.setPinfl((String) pinfl);
      Object phoneNumber = pigeonVar_list.get(3);
      pigeonResult.setPhoneNumber((String) phoneNumber);
      Object lastLogin = pigeonVar_list.get(4);
      pigeonResult.setLastLogin((String) lastLogin);
      Object environment = pigeonVar_list.get(5);
      pigeonResult.setEnvironment((ManiEnvironment) environment);
      Object residentType = pigeonVar_list.get(6);
      pigeonResult.setResidentType((ManiResidentType) residentType);
      Object designVariant = pigeonVar_list.get(7);
      pigeonResult.setDesignVariant((DesignVariant) designVariant);
      Object brightness = pigeonVar_list.get(8);
      pigeonResult.setBrightness((PullyBrightness) brightness);
      return pigeonResult;
    }
  }
  ...
  private static class PigeonCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        case (byte) 129: {
          ...
          return value == null ? null : ManiEnvironment.values()[((Long) value).intValue()];
        }
        case (byte) 130: {
          Object value = readValue(buffer);
          return value == null ? null : ManiResidentType.values()[((Long) value).intValue()];
        }
        case (byte) 131: {
          Object value = readValue(buffer);
          return value == null ? null : DesignVariant.values()[((Long) value).intValue()];
        }
        case (byte) 132: {
          Object value = readValue(buffer);
          return value == null ? null : PullyBrightness.values()[((Long) value).intValue()];
        }
        case (byte) 133: {
          Object value = readValue(buffer);
          return value == null ? null : CancelReason.values()[((Long) value).intValue()];
        }
        case (byte) 134:
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      if (value instanceof ManiEnvironment) {
        stream.write(129);
      ...
      } else if (value instanceof PullyBrightness) {
        stream.write(132);
        writeValue(stream, value == null ? null : ((PullyBrightness) value).index);
      } else if (value instanceof CancelReason) {
        stream.write(133);
        writeValue(stream, value == null ? null : ((CancelReason) value).index);
  ...
  public static class ManiAuthApi {
    ...
    public void send(@NonNull HostInfo hostInfoArg, @NonNull VoidResult result) {
      ...
      channel.send(
          new ArrayList<>(Collections.singletonList(hostInfoArg)),
          channelReply -> {
  ...
  public interface HostAppApi {
    ...
    void cancel(@NonNull CancelReason reason);
        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                CancelReason reasonArg = (CancelReason) args.get(0);
                try {
